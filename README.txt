...
Главный экран MainTableViewConrtoller показывает список «уже просмотренных» персонажей, который наполняется из Core Data. Детальная информация о персонажахе из данного списка доступна без интернета.
